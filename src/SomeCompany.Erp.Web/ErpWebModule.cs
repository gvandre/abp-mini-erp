...
using SomeCompany.Erp.Web.Menus;
    ...
    public class ErpWebModule : AbpModule
    {
        ...
        private void ConfigureVirtualFileSystem(IWebHostEnvironment hostingEnvironment)
        {
            if (hostingEnvironment.IsDevelopment())
            {
                ...
                {
                    options.FileSets.ReplaceEmbeddedByPhysical<ErpDomainSharedModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}SomeCompany.Erp.Domain.Shared"));
                    options.FileSets.ReplaceEmbeddedByPhysical<ErpDomainModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}SomeCompany.Erp.Domain"));
                    options.FileSets.ReplaceEmbeddedByPhysical<ErpApplicationContractsModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}SomeCompany.Erp.Application.Contracts"));
                    options.FileSets.ReplaceEmbeddedByPhysical<ErpApplicationModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}SomeCompany.Erp.Application"));
